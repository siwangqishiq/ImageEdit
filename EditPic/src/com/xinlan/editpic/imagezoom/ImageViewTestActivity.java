package com.xinlan.editpic.imagezoom;
...
import com.xinlan.editpic.imagezoom.ImageViewTouch.OnImageViewTouchDoubleTapListener;
import com.xinlan.editpic.imagezoom.ImageViewTouch.OnImageViewTouchSingleTapListener;
import com.xinlan.editpic.imagezoom.ImageViewTouchBase.DisplayType;
import com.xinlan.editpic.imagezoom.ImageViewTouchBase.OnDrawableChangeListener;
import com.xinlan.editpic.imagezoom.utils.DecodeUtils;
	...
	public void selectRandomImage() {
		...
		if (c != null) {
			...
			if (c.moveToPosition(position)) {
				...
				// imageUri = Uri.parse(
				// "content://media/external/images/media/7993" ); // test
